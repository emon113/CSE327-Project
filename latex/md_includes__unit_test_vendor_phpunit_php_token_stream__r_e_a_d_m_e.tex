{\texttt{ }} {\texttt{ }}\doxysection{Installation}\label{md_includes__unit_test_vendor_phpunit_php_token_stream__r_e_a_d_m_e_autotoc_md279}
You can add this library as a local, per-\/project dependency to your project using {\texttt{ Composer}}\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{composer require phpunit/php-\/token-\/stream}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{composer require -\/-\/dev phpunit/php-\/token-\/stream}
